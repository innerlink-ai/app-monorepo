<template>
  <div class="flex h-screen bg-[var(--background)]">
    <!-- Main content area -->
    <div class="flex flex-col flex-grow items-center justify-center px-4 md:px-0">
      <div class="w-full max-w-md bg-[var(--chat-bg)] p-8 rounded-xl shadow-lg border border-[var(--border-color)]">
        <!-- Logo and Header -->
        ...
        <h2 class="text-lg font-medium mb-6 text-center text-[var(--text-color)]">System Setup</h2>
        
        <div class="text-center mb-6 text-[var(--secondary-text)]">
          <p>Welcome to your secure communication platform.</p>
          <p class="mt-2">Let's set up your administrator account to get started.</p>
        </div>
        ...
        <div v-if="inviteSent" class="space-y-6">
          ...
          <div class="bg-[var(--button-hover-lighter)] p-4 rounded-lg border border-[var(--border-color)]">
            <p class="text-[var(--secondary-text)]">An invitation has been sent to <strong class="text-[var(--text-color)]">{{ email }}</strong></p>
            <p class="text-[var(--secondary-text)] mt-2">Please check your email to complete your registration.</p>
          </div>

          <div class="rounded-lg border border-[var(--border-color)] overflow-hidden">
            <div class="px-4 py-3 bg-[var(--button-hover-lighter)] border-b border-[var(--border-color)]">
              <h3 class="font-medium text-[var(--text-color)]">Next Steps</h3>
            </div>
            <div class="p-4 space-y-3">
              <div class="flex items-start">
                <div class="flex-shrink-0 w-6 h-6 rounded-full bg-[#55B867] bg-opacity-20 flex items-center justify-center mt-0.5 mr-3">
                  <span class="text-xs font-medium text-[#55B867]">1</span>
                </div>
                <p class="text-sm text-[var(--secondary-text)]">Check your email inbox for a message from Innerlink</p>
              </div>
              <div class="flex items-start">
                <div class="flex-shrink-0 w-6 h-6 rounded-full bg-[#55B867] bg-opacity-20 flex items-center justify-center mt-0.5 mr-3">
                  <span class="text-xs font-medium text-[#55B867]">2</span>
                </div>
                <p class="text-sm text-[var(--secondary-text)]">Click the secure registration link in the email</p>
              </div>
              <div class="flex items-start">
                <div class="flex-shrink-0 w-6 h-6 rounded-full bg-[#55B867] bg-opacity-20 flex items-center justify-center mt-0.5 mr-3">
                  <span class="text-xs font-medium text-[#55B867]">3</span>
                </div>
                <p class="text-sm text-[var(--secondary-text)]">Complete your account registration</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <!-- Footer -->
      <div class="mt-4 text-[var(--secondary-text)] text-sm">
        <p>© 2025 Innerlink. All rights reserved.</p>
      </div>
    </div>
  </div>
</template>
